...
public extension Account {
    ...
    /// Example: "mammoth@rheinneckar.social" would return "rheinneckar.social"
    var server: String {
        var server = ""
    ...
    /// Example: "mammoth" would return "mammoth@rheinneckar.social"
    var fullAcct: String {
    ...
    ///  "rileyhBat@rheinneckar.social" will return it as it is on the servers
    /// Example: username "Mammoth" would return "Mammoth@rheinneckar.social"
