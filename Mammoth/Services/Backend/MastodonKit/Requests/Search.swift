...
public struct Search {
    ...
    public static func searchAutocompleteAccounts(query: String) -> Request<[Account]> {
        // https://rheinneckar.social/api/v1/accounts/search?q=stro&resolve=false&limit=4
        // Using a v1 api for account autocomplete because there seems to be compatibility issues with rheinneckar.social and mastodon.social.
